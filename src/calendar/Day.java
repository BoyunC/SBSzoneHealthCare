...
public class Day {
	...
	static String[] time = new String[] { "09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "13:00", "13:30",
	...
	public void cancelAppointment() {
		...
		System.out.println("[system] 예약 취소가 완료되었습니다.");
	}
	...
	public void showAppointments() {
		int i = 0;
		System.out.println("[system] " + date + "일 예약 현황 -------------");
		System.out.println();
	...
	public void makeAppointment() {
		...
		// 예약 내역 출력
		System.out.println("[system] 예약 완료 ------ ");
...
//		if(this.date == Calendar.DATE ) {
//			Calendars.days.add(this);
//		}
	...
	public Appointment searchAppointment(Patient p) {
		...
		for (int i = 0; i < appointments.length; i++) {
			if (appointments[i].getPatient().getName().equals(p.getName())) {
				...
				System.out.println("[" + (cnt++) + "] " + appointments[i].getDate().get(Calendar.MONTH) + "월 "
						+ appointments[i].getDate().get(Calendar.DATE) + "일 " + appointments[i].getTime());
			}
		}
		System.out.print("[system] 수정 또는 취소할 예약 번호 입력 : ");
